...
pub fn RegisterPage() -> Element {
    ...
    use_future(move || async move {
        web_sys::console::log_1(&"[lets-chat] use_future entered".into());
        gloo_timers::future::TimeoutFuture::new(0).await;
        web_sys::console::log_1(&"[lets-chat] yield returned, setting hydrated=true".into());
        hydrated.set(true);
        web_sys::console::log_1(&"[lets-chat] hydrated.set(true) returned".into());
    });
    ...
    if !hydrated() {
        return rsx! {
            div {
                ...
                onmounted: move |_| {
                    #[cfg(target_arch = "wasm32")]
                    web_sys::console::log_1(&"[lets-chat] onmounted fired".into());
                },
