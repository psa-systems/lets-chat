...
# LC-862: lead the waiting card with an explicit confirmation that a request was
# created, carrying the reference (the ticket number is appended after this).
support-waiting-ref = Your request was filed. Reference
