...
enclave-settings-coyote-help = When on, a member who posts in 3 or more rooms of this enclave within 3 seconds is treated as a bot: banned from this enclave and their messages from the last 24 hours in this enclave are removed. Enclave admins are exempt.
