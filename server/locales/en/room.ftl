...
room-msg-translate-to = Translate to
room-msg-translated-to = Translated to
room-msg-translate-language = Translation language
...
room-remote-control-heading = Remote control of shared screens
room-remote-control-intro = Let a huddle participant ask to control a shared screen in this room; the sharer approves each request.
room-remote-control-workspace-off = Remote control is turned off workspace-wide, so this setting has no effect until an admin enables it.
room-remote-control-on-label = On.
room-remote-control-on-text = Participants can request control of a shared screen in this room.
room-remote-control-off-label = Off.
room-remote-control-off-text = Remote control is disabled in this room.
