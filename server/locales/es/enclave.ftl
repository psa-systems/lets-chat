...
enclave-settings-coyote-help = Cuando esta activo, un miembro que publica en 3 o mas salas de este enclave en 3 segundos se trata como un bot: se le expulsa de este enclave y se eliminan sus mensajes de las ultimas 24 horas en este enclave. Los administradores del enclave estan exentos.
