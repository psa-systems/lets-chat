...
admin-nav-voice-log = Registro de voz
...
# LC-862: la tarjeta de espera confirma de forma explícita que se creó una
# solicitud e incluye la referencia (el número de ticket se añade después).
support-waiting-ref = Registramos tu solicitud. Referencia
