...
# LC-712: base de conocimiento de documentacion de la mesa de ayuda con IA.
admin-settings-helpdocs-heading = Mesa de ayuda con IA (documentacion)
admin-settings-helpdocs-unconfigured-title = No hay endpoint de embeddings configurado.
admin-settings-helpdocs-unconfigured-body = La busqueda de documentacion queda vacia hasta configurar un endpoint de embeddings mediante
admin-settings-helpdocs-note = El asistente /support responde a partir de la documentacion del producto indexada abajo. Anade una fuente por linea como "producto | URL-del-indice-de-docs"; el indexador recorre las subpaginas de esa pagina, las divide por encabezados y las incrusta. Guarda los cambios y luego reindexa (o espera la actualizacion periodica).
admin-settings-helpdocs-sources-label = Fuentes de documentacion
admin-settings-helpdocs-sources-note = Una por linea: nombre del producto, una barra vertical y la URL del indice de docs. Ejemplo: mokosh-server | https://a8n.systems/apps/mokosh-server/docs
admin-settings-helpdocs-save = Guardar fuentes
admin-settings-helpdocs-index-label = Indexado
admin-settings-helpdocs-index-chunks = fragmentos
admin-settings-helpdocs-index-products = productos
admin-settings-helpdocs-reindex = Reindexar ahora
admin-settings-helpdocs-reindex-started = Reindexado iniciado; se ejecuta en segundo plano.
